...
namespace CourseList
{
    public partial class CourseListForm : Form
    {
        ...
        public CourseListForm()
        {
            ...
            courseListView.GridLines = false;
            courseListView.Location = new Point(1, 2);
            courseListView.MultiSelect = false;
            courseListView.Size = new Size(798, 348);
            courseListView.TabIndex = 1;
            courseListView.View = View.Details;

            
            courseListView.Columns.Add("codeHdr", "Code", 180).DisplayIndex = 0;
            courseListView.Columns.Add("descHdr", "Description", 250).DisplayIndex = 1;
            courseListView.Columns.Add("instructorName", "Instructor", 175).DisplayIndex = 2;
            courseListView.Columns.Add("dowHdr", "Days", 100).DisplayIndex = 3;
            courseListView.Columns.Add("timeHdr", "Time", 300).DisplayIndex = 4;

  
            Controls.Add(courseListView);

            courseListView.ItemActivate += CourseListView__ItemActivate;
            ...
            courseListView.KeyDown += CourseListView__KeyDown;
            ...
            courseListView.SelectedIndexChanged += CourseListView__SelectedIndexChanged;
        ...
        public void PaintListView(string firstCourseCode)
        {
            ...
            {
                // 11. fetch the index of firstCourseCode from the Globals.courses.sortedList using IndexOfKey method
             ...
             if (firstLVI != null)
    {
        ...
        if (course != null)
            {
            if (Globals.courses.TryGetValue(courseCode, out course))
            {
        ...
        if (e.KeyCode == Keys.Enter)
        {
            ...
            e.Handled = true;
                ...
                if (courseCode != null && Globals.courses.TryGetValue(courseCode, out course))
                {
