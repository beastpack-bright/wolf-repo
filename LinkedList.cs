    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button4__Click(object sender, EventArgs e)
        {
            ...
            // 4. Your code here
            LinkedListNode<object> currentNode = linkedList.First;
            while (currentNode != null)
            {
                if ((string)currentNode.Value == "sad")
                {
                    currentNode.Value = "happy";
                }
                else if ((string)currentNode.Value == "sadness")
                {
                    currentNode.Value = "happiness";
                }
        ...
        private void Button5__Click(object sender, EventArgs e)
        {
            ...
            LinkedListNode<object> spainNode = linkedList.Find("Spain");
            LinkedListNode<object> fallsNode = linkedList.Find("falls");

            linkedList.Remove("in");
            linkedList.Remove("on");
            linkedList.Remove("the");
            linkedList.Remove("mainly");

         
            spainNode = linkedList.Find("Spain");
            fallsNode = linkedList.Find("falls");

           
            inNode.Value = "rain";
            spainNode.Value = "in";
            fallsNode.Value = "falls";

         
            LinkedListNode<object> nodeAfterFalls = linkedList.Find("falls").Next;

           
            linkedList.AddAfter(nodeAfterFalls, "mainly");
            ...
            LinkedListNode<object> rainNode = linkedList.Find("rain");
            linkedList.Remove("rain");

            LinkedListNode<object> inAfterNode = linkedList.Find("in");
            linkedList.Remove("in");

            LinkedListNode<object> fallsAfterNode = linkedList.Find("falls");
            linkedList.Remove("falls");

            LinkedListNode<object> mainlyNode = linkedList.Find("mainly");
            linkedList.Remove("mainly");

          
            linkedList.AddFirst(new LinkedListNode<object>("The"));
            linkedList.AddLast(rainNode);
            linkedList.AddLast(inAfterNode);
            linkedList.AddLast(new LinkedListNode<object>("Spain"));
            linkedList.AddLast(fallsAfterNode);
            linkedList.AddLast(mainlyNode);


            linkedList.AddLast(new LinkedListNode<object>("on"));
            linkedList.AddLast(new LinkedListNode<object>("the"));


            linkedList.Remove("plain");


            linkedList.AddLast(new LinkedListNode<object>("plain"));
        ...
        {
            LinkedListNode<object> linkedListNodeD;
            LinkedListNode<object> linkedListNodeI;

            string[] letters = { "D", "O", "R", "M", "I", "T", "O", "R", "Y" };
            LinkedList<object> anagram = new LinkedList<object>(letters);

            
            linkedListNodeD = anagram.Find("D");
            linkedListNodeI = anagram.Find("I");
            ...
            LinkedListNode<object> nodeD = new LinkedListNode<object>("D");
            LinkedListNode<object> nodeI = new LinkedListNode<object>("I");

        
            anagram.AddLast(nodeD);
            anagram.AddLast(nodeI);
            anagram.AddLast(new LinkedListNode<object>("R"));
            anagram.AddLast(new LinkedListNode<object>("T"));
            anagram.AddLast(new LinkedListNode<object>("Y"));
            anagram.AddLast(new LinkedListNode<object>("R"));
            anagram.AddLast(new LinkedListNode<object>("O"));
            anagram.AddLast(new LinkedListNode<object>("O"));
            anagram.AddLast(new LinkedListNode<object>("M"));
